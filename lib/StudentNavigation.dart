...
import 'package:math_matters/StudentHome.dart';
import 'package:math_matters/main.dart';
import 'package:math_matters/puzzle.dart';
...
class _StudentNavState extends State<StudentNav> {
  ...
  void initState(){
    ...
    super.initState();
    _widgetoption = [FeedbackPage(title: 'Confirm'), puzzle(title: 'puzzles'),StudentHome(title: 'Doordash'),profile(title: 'title'), Feedbacks(title: "Progress Tracker")];//removed feedbacks
    setState(() {
